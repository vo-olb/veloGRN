...
def get_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument('-c','--BFcorr', action='store_true', default = True,
                        help='Perform Bonferroni correction. Default = True. \n')
    
    parser.add_argument('-n','--numGenes', type=int, default = 1000,
                        help='Number of genes to add. Default=1000. \n')

    parser.add_argument('-t','--TFs', action='store_true', default = True,
                        help='Add all significantly varying TFs. Default = True.\n')

    parser.add_argument('-o','--outPrefix', type = str, default = '../data/mESC/',
...
print("\nNEXT, YOU MAY RUN `scripts/03_model.sh` TO TRAIN MODEL\n")